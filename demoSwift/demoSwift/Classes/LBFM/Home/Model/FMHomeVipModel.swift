...
struct FMVipFocusImagesModel: HandyJSON {
    var data:[FMVipFocusImagesData]?
    var responseId: Int = 0
    var ret: Int = 0
}

struct FMVipFocusImagesData: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
...
struct FMVipCategoryContentsModel: HandyJSON {
    var list: [FMCategoryContentsList]?
    var title: String?
}

struct FMCategoryContentsList: HandyJSON {
    var list: [FMContentsList]?
...
struct FMContentsList: HandyJSON {
...
struct FMContentListGridModel:HandyJSON {
    ...
    var title: String?
    var url: String?
    var properties : FMGridProperties?
}

struct FMGridProperties:HandyJSON {
    var isPaid:Bool = false
    var type:String?
    var uri:String?
}
